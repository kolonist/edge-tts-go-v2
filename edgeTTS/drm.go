...
var clock_skew_seconds int64 = 0
...
*/
func generate_sec_ms_gec() string {
	...
	str_to_hash := fmt.Sprintf("%d%s", ticks, TRUSTED_CLIENT_TOKEN)
...
*/
func get_unix_timestamp() int64 {
	return time.Now().Unix() + clock_skew_seconds
}
